...
public class PDFPagerAdapter extends BasePDFPagerAdapter
    ...
    public PDFPagerAdapter(Context context, String pdfPath) {
        ...
        sp = context.getSharedPreferences("tempPosition", context.MODE_PRIVATE);
        tempPosition = sp.getInt("position",0);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        PdfRenderer.Page page = getPDFPage(renderer, position+tempPosition);

        Bitmap bitmap = bitmapContainer.get(position+tempPosition);
        ...
        edit.putInt("position",position+tempPosition);
        edit.commit();
